...
const tracy_full = struct {
    ...
    const has_tracy_callstack = @hasDecl(c, "TRACY_CALLSTACK");
    const has_include_callstack_bo = @import("build_options").include_callstack;
    const has_callstack_support = has_include_callstack_bo and has_tracy_callstack;
    // const callstack_enabled = @import("build_options").include_callstack;
