...
pub fn StaticOverlay(PaletteType: type, spawn_fn: fn (scene: *Scene, item_idx: usize, pos: rl.Vector2) Scene.SpawnError!void, max_amount_of_items: usize) type {
    return struct {
...
pub const MobOverlay = StaticOverlay(Palette.MobPalette, Scene.spawnMob, constants.MAX_AMOUNT_OF_MOBS);
pub const CollectableOverlay = StaticOverlay(Palette.CollectablePalette, Scene.spawnCollectable, constants.MAX_AMOUNT_OF_COLLECTABLES);
