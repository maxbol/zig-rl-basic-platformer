...
pub fn StaticPalette(ItemType: type, palette_type: ActivePaletteType, item_size: f32, no_cols: usize, no_rows: usize) type {
    return struct {
        pub const Item = ItemType;
        pub const window_width = item_size * no_cols;
        pub const window_height = item_size * no_rows;

        on_focus: *const fn (editor: *Editor, palette_type: ActivePaletteType) void,
        focused: bool = false,
        window: rl.Rectangle,
        ...
        pub fn init(on_focus: *const fn (editor: *Editor, palette_type: ActivePaletteType) void, offset_x: f32, offset_y: f32) @This() {
        ...
        pub fn draw(self: *const @This(), _: *const Editor) void {
...
pub const MobPalette = StaticPalette(Actor.Mob, ActivePaletteType.Mob, 24, 5, 2);
pub const CollectablePalette = StaticPalette(Collectable, ActivePaletteType.Collectable, 24, 3, 2);
